...
<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
    ...
    <div class="gallery col-sm-12" style="">
        ...
        {section name=i loop=$places}
            ...
            -->
            <div class="gallery-item2 " data-id="{$places[i].place_id}"  event="click" name="galeryItem" params="id_place={$places[i].place_id}" data-width="1" data-height="1">
                <!-- START PREVIEW -->
            ...
            {literal}
                <style>
                    .activity-{/literal}{$activityLst[i]->getID()}{literal}:after{
                        background-image: url({/literal}{$activityLst[i]->getFirstPhoto()}{literal}) !important;
                    }
                </style>
            {/literal}
            <!-- START ROW -->
            <div class="col-sm-12 m-b-10 gallery-item2" event="click" name="galeryItem"  data-id="{$activityLst[i]->getID()}"  params="id_activity={$activityLst[i]->getID()}">
                <div class="ar-1-1">
                    ...
                    <div class="widget-2 panel no-border bg-primary widget widget-loader-circle-lg no-margin activity-{$activityLst[i]->getID()}" >
                        <div class="panel-heading">
                            <div class="panel-controls">
                                <ul>
                                    <li><a href="#" params="id_activity={$activityLst[i]->getID()}" id="btnbookmarkit"  name="btnbookmarkit"  event="click" url="Dreamboard"  class="portlet-refresh" data-toggle="refresh"><i
                        ...
                        <div class="panel-body">
                            <div class="pull-bottom bottom-left bottom-right padding-25">
                                ...
                                <p class="text-white hint-text hidden-md">{$activityLst[i]->getDescription()|truncate:30:''}</p>
        ...
        {section name=i loop=$eventLst}
            ...
            <!--
                  ...
                  FOR SCREENS <920px. PLEASE REMOVE THE CLASS 'first' WHEN YOU IMPLEMENT
            -->
            <div class="gallery-item2 " data-id="{$eventLst[i]->getID()}"  event="click" name="galeryItem" params="id_event={$eventLst[i]->getID()}" data-width="1" data-height="1">
                <!-- START PREVIEW -->
                <div class="live-tile slide" data-speed="750" data-delay="4000" data-mode="carousel">
