...
//#################################################################################### 
							 	...
							 	function ()
									...
									if (p.colModel[idx]['type'] == 'checkbox')
										td.innerHTML = '<input type="checkbox" id="'+ row.id +'" />'
										
									else if (p.colModel[idx]['type'] == 'img') {
										if (p.colModel[idx]['condicao'] != null){
											if (p.colModel[idx]['operador'] == '==') {
												if (row.cell[idx] == p.colModel[idx]['condicao']) 
													td.innerHTML = '<img src="' + p.colModel[idx]['img1'] + '" alt="" border="0" />'
												else 
													td.innerHTML = '<img src="' + p.colModel[idx]['img2'] + '" alt="" border="0" />';
											}
											else if (p.colModel[idx]['operador'] == '!=') {
												if (row.cell[idx] != p.colModel[idx]['condicao']) 
													td.innerHTML = '<img src="' + p.colModel[idx]['img1'] + '" alt="" border="0" />'
												else 
													td.innerHTML = '<img src="' + p.colModel[idx]['img2'] + '" alt="" border="0" />';
										...
										if (p.colModel[idx]['condicao'] != null) {
											if (p.colModel[idx]['operador'] == '==') {
												if (row.cell[idx] == p.colModel[idx]['condicao'])
													td.innerHTML = '<a href="' + link + '"><img src="' + p.colModel[idx]['img1'] + '" alt="" border="0" /></a>';
												else 
													td.innerHTML = '<a href="' + link + '"><img src="' + p.colModel[idx]['img2'] + '" alt="" border="0" /></a>';
											}
											else if (p.colModel[idx]['operador'] == '!=') {
													if (row.cell[idx] != p.colModel[idx]['condicao'])
														td.innerHTML = '<a href="' + link + '"><img src="' + p.colModel[idx]['img1'] + '" alt="" border="0" /></a>';
											...
											td.innerHTML = '<a href="' + row.cell[idx] + '"><img src="' + p.colModel[idx]['img1'] + '" alt="" border="0" /></a>';
									}
			...
			for (i=0;i<p.colModel.length;i++)
				{
					...
					if (p.colModel[i]['type'] == 'checkbox') 
						th.innerHTML = '<input type="checkbox" id="chklstTodos' + i + '" alt="' + p.colModel[i]['alt'] + '" title="' + p.colModel[i]['alt'] + '" />';
					
					else if ((p.colModel[i]['type'] == 'img') || (p.colModel[i]['type'] == 'imgLink')) {
						if ((p.colModel[i]['src'] != null) && (p.colModel[i]['src'] != ''))
