...
class Ui_Element_DataTables_Column_Check extends Ui_Element_DataTables_Column_Abstract {
	protected $alt;
...
//			$html = "<input type='checkbox' alt='{$this->alt}' title='{$this->alt}' id='gridChk_{$numRow}' name='gridChk_{$numRow}' ";
			$html = "<input type='checkbox' alt='{$this->alt}' title='{$this->alt}' id='gridChk_{$oid}' name='gridChk_{$oid}' ";
